...
// FileAdminAPI - File Admin API
type FileAdminAPI struct {
	sdkConfiguration sdkConfiguration
}

func newFileAdminAPI(sdkConfig sdkConfiguration) *FileAdminAPI {
	return &FileAdminAPI{
		sdkConfiguration: sdkConfig,
	}
}

// RevokeURL - Revoked the Signed URL
...
func (s *FileAdminAPI) RevokeURL(ctx context.Context, request map[string]string, opts ...operations.Option) (*operations.RevokeURLResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/files/revokeURL")
	if err != nil {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.sdkConfiguration.Hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "401", "403", "4XX", "500", "502", "503", "5XX"}, httpRes.StatusCode) {
	...
	res := &operations.RevokeURLResponse{
