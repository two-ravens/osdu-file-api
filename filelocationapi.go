...
// FileLocationAPI - File Location API
type FileLocationAPI struct {
	sdkConfiguration sdkConfiguration
}

func newFileLocationAPI(sdkConfig sdkConfiguration) *FileLocationAPI {
	return &FileLocationAPI{
		sdkConfiguration: sdkConfig,
	}
}

// GetLocationFile - Get a location in Landing Zone to upload a file.
...
func (s *FileLocationAPI) GetLocationFile(ctx context.Context, dataPartitionID string, expiryTime *string, opts ...operations.Option) (*operations.GetLocationFileResponse, error) {
	...
	request := operations.GetLocationFileRequest{
	...
	opURL, err := url.JoinPath(baseURL, "/v2/files/uploadURL")
	if err != nil {
	...
	res := &operations.GetLocationFileResponse{
