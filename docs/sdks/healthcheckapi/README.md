...
* [ReadinessCheck](#readinesscheck) - Readiness Check endpoint
...
func main() {
    ...
    res, err := s.HealthCheckAPI.ReadinessCheck(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
...
**[*operations.ReadinessCheckResponse](../../models/operations/readinesscheckresponse.md), error**
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.HealthCheckAPI.LivenessCheck(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
